...
from tests.conftest import db, client, container
...
def test_register_user_api_with_correct_data(client, db, container):
...
def test_register_user_api_with_bad_email_address(client, db):
...
def test_login_user_api_with_correct_data(client, db, container):
...
def test_login_user_api_with_incorrect_data(client, db, container):
    email = "mohi@gmail.com"
    password = "123456789"
